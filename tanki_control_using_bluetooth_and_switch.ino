...
if(mySerial.available()>0)//checks if serial data is available at pin 9 from bluetooth module module
{
  Serial.println("transfers data from bluetooth module to arduino as 1,2,3.... FOR SWITCH CASE");//print on serial monitor
    ...
    switch(t)
  {
  case 1://if text message from mobile is 1 this case executes and motor starts in clockwise direction
  ...
  delay(5000);
  break;
  case 2://if text message from mobile is 2 this case executes and motor starts in anticlockwise direction
  ...
  delay(5000);
  break;
  default ://when text message is anything except 1 or 2 than this case executes and motor remains off 
